module.exports = {
	...
	adminId: "246072905992110082", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTA5ODAyMDYwMTMxNjI1MzcxNg.GCipzZ.GY8jAq_lpN___vZ975dnWaWmbaIl9rAsAIR4pQ", //- Bot's Token
	clientId: process.env.clientId || "1098020601316253716", //- ID of the bot
	clientSecret: process.env.clientSecret || "-lTim_li0rFTPJV8Ngj0xYUsDz2N3yba", //- Client Secret of the bot
	...
	supportServer: "https://discord.gg/NWzMXhZ", //- Support Server Link
