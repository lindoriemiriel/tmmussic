  ...
  .setRun(async (client, interaction) => {
    ...
    helpEmbed.addFields({
      ...
      value:
        ...
        "\n" +
        `[✨ Destek Sunucusu](${client.config.supportServer}) | [Sorun](${client.config.Issues}) | [Kaynak]() | [Davet et](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`,
    });
